...
namespace MovilApp.Controllers
{
    class UserManager
    {
        ...
        string UrlAuthenticate = "localhost/api/login/authenticate";
        string UrlRegister = "localhost/api/login/register";
        string UrlAllUser = "localhost/api/login/allUser";
        string UrlChangePassword = "localhost/api/login/actualizarUser";
        ...
        public async Task<int> obtenerUsuarioID(string correo, string clave)
        {
            ...
            string resultado = await httpClient.GetStringAsync($"localhost/api/login/getID?correo={correo}&clave={clave}");
