...
namespace MovilApp.Controllers
{
    class UserManager
    {
        ...
        string UrlAuthenticate = "http://192.168.88.32:45457/api/login/authenticate";
        string UrlRegister = "http://192.168.88.32:45457/api/login/register";
        string UrlAllUser = "http://192.168.88.32:45457/api/login/allUser";
        ...
        public async Task<int> obtenerUsuarioID(string correo, string clave)
        {
            ...
            string resultado = await httpClient.GetStringAsync($"http://192.168.88.32:45457/api/login/getID?correo={correo}&clave={clave}");
